...
target_sequences = keras.preprocessing.sequence.pad_sequences(target_sequences, maxlen=max_sequence_length, padding='post')
...
for filename in os.listdir(image_folder):
    if filename.endswith(('.jpg', '.png', '.jpeg')):  # Add more extensions as needed
        ...
        results = pytesseract.image_to_data(rgb, output_type=Output.DICT) # type: ignore
